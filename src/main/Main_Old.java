...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        fname = new SimpleDateFormat("yyyy-MM-dd_HH:mm:ss").format(new java.util.Date());
        file = new File("./logs/" + fname + ".log");
        try {
            file.createNewFile();
        } catch (IOException e) {
            e.printStackTrace();
        ...
        out.println("Number of players: " + numPlayers);
        out.println("Cell number: " + cellNum);
    ...
    public static int playTurn (Interfaces intface, Grid grid, int player) {
        ...
        out.println("Mouse clicked at: " + x + ", " + y);
